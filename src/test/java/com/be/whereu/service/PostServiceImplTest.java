...
//    @Test
//    void testGetBoardDetailsListWIthoutId() {
//        Pageable pageable= PageRequest.of(0,10);
//        Page<PostEntity> postPage= new PageImpl<>(postEntities,pageable,postEntities.size());
//
//        when(postRepository.findAll(pageable)).thenReturn(postPage);
//
//        List<PostResponseDto> result= postService.getBoardDetailsList(null,0);
...
//
//        List<PostResponseDto> result = postService.getBoardDetailsList(1L, 0);
//
//        assertEquals(2, result.size());
//        assertEquals("Title 1", result.get(0).getTitle());
//    }
